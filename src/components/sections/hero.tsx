      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="grid items-center gap-12 md:grid-cols-[1fr_auto] md:gap-16">
          ...
          <div>
            {/* Headline */}
            <h1
              className="max-w-3xl font-heading font-bold leading-[1.05] tracking-tight text-black animate-fade-in-up"
            ...
            {/* Body */}
            <p className="mt-7 max-w-xl text-lg leading-relaxed text-warm-gray animate-fade-in-up animation-delay-200">
            ...
            <a
              href="#contact"
              className="mt-9 inline-flex items-center gap-2 font-heading text-lg font-semibold text-terracotta transition-colors hover:text-terracotta-light animate-fade-in-up animation-delay-400"
            >
          ...
          <div className="animate-fade-in-up animation-delay-400 flex shrink-0 justify-center md:justify-end">
            <div
              className="relative overflow-hidden rounded-2xl bg-sand border border-border"
