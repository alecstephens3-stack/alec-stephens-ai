#!/usr/bin/env python3
"""Build an artifact-ready page from a round 5 content fragment.
...
Markers a fragment may use:
    ...
    SAI5:KB       the knowledge base widget      (_parts/kb.html)
    SAI5:REEXAM   the 6 touch sequence           (_parts/reexam.html)
    SAI5:TIMEOFF  the time off request           (_parts/timeoff.html)
    SAI5:FAQ      the questions accordion        (_parts/faq.html)
